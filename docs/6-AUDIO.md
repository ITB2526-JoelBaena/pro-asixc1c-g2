...
**Servidor:** `audio-innovatetech` — `10.0.1.50`  
**IP elàstica:** `34.196.148.33`  
**Software:** Icecast2 + Liquidsoap  
**Port:** 8000
...
- [6.1 Descripció del servei](#61-descripció-del-servei)
- [6.2 Tecnologia escollida: Icecast2 + Liquidsoap](#62-tecnologia-escollida-icecast2--liquidsoap)
- [6.3 Formats d'àudio utilitzats](#63-formats-dàudio-utilitzats)
- [6.4 Arquitectura del servei](#64-arquitectura-del-servei)
- [6.5 Instal·lació i configuració](#65-installació-i-configuració)
- [6.6 Comprovació del servei](#66-comprovació-del-servei)
...
**Accés via navegador:**
- Panell d'administració: `http://34.196.148.33:8000`
- Stream d'àudio: `http://34.196.148.33:8000/stream`
